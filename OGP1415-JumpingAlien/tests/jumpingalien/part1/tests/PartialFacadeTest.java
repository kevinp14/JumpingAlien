...
public class PartialFacadeTest {
	...
	@Test
	public void testStartMoveLeftEndMoveRight(){
		IFacade facade = new Facade();		
	...
	@Test
	public void testStartDuckIsDucking(){
		IFacade facade = new Facade();
		
		Mazub alien = facade.createMazub(0,0,spriteArrayForSize(2,2));
		facade.startDuck(alien);
		assertEquals(true,alien.isDucking());
	}
	
	@Test
	public void testJumpRightAcceleration(){
		IFacade facade = new Facade();
	...
	public void testIsMovingLeft(){
		...
		assertEquals(false, alien.isMovingLeft());
	}
	...
	public void testHasJustMovedHorizontal(){
		...
		assertEquals(false, alien.isMovingHorizontally());
		assertEquals(true, alien.hasJustMovedHorizontally());
	}
}
